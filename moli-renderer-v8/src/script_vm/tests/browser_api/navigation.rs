        ...
        .eval(
            ...
            (() => {
              ...
              return JSON.stringify({
                ...
                fakeNavigationType: (() => {
                  try { return String(navigationTypeGetter.call(fakeNavigation)); }
