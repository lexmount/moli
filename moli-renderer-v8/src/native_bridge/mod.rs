...
pub(crate) use context_host::{
    ...
    synthetic_window_context_can_access, throw_cross_origin_location_security_error,
    throw_cross_origin_type_error, window_contexts_allow_access,
};
...
pub(crate) use node::{
    ...
    node_owner_document_relevant_context, node_relevant_context,
