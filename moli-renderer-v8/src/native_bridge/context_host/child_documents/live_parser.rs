use super::super::document_parser_owner::ContextDocumentParserOwner;
...
use crate::{
    ...
    live_document_parser::{
        ...
        DocumentParserSession, LiveDocumentParserStepOutcome, ParserStopReason,
    ...
    parser::{ParserScriptHandoff, PreparedImportMapSource},
...
impl JsContextHost {
    ...
    fn resolve_live_child_parser_script_preparation(
        ...
        prepare_script: impl FnOnce(
            ...
            &mut ContextDocumentParserOwner<'_, '_, '_>,
        ) -> ParserScriptHandoff,
        ...
        let mut owner = ContextDocumentParserOwner::new_child(self, scope, document_handle);
