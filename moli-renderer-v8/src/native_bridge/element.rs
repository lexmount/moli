...
pub(crate) use event_handlers::{
    ...
    compile_window_event_attribute_handler, event_handler_content_attribute_name,
    initialize_parser_inserted_body_window_event_handlers, legacy_lenient_this_event_handler,
