use super::{
    ...
    current_storage_scope, database_handle_from_value, dom_exception_value,
    ...
    object_string_property, origin_allows_indexed_db, parse_optional_idb_key_path_member,
    register_indexed_db_databases_settle_task, register_readwrite_transaction,
    remove_database_store_metadata, request_error_object, require_idb_key,
