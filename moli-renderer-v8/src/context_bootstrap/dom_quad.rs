use super::*;
use crate::{
    util::{callback_data_index_value, get_private_object},
...
#[derive(WebApiObject)]
#[webapi(interface = web_api_interfaces::DOMQuad, fallback_to_string_tag = "DOMQuad")]
...
#[webapi(interface = web_api_interfaces::DOMQuad)]
...
#[derive(WebApiFunctionTemplate)]
#[webapi(interface = web_api_interfaces::DOMQuad, enumerable)]
...
fn dom_quad_receiver_branded<'s>(
    ...
    web_api_interfaces::DOMQuad::is_instance(scope, receiver)
}
