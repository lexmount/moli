...
#[derive(WebApiObject)]
#[webapi(
    interface = web_api_interfaces::SVGAnimatedBoolean,
...
#[derive(WebApiObject)]
#[webapi(
    interface = web_api_interfaces::SVGAnimatedInteger,
...
#[derive(WebApiObject)]
#[webapi(
    interface = web_api_interfaces::SVGAnimatedAngle,
...
#[derive(WebApiObject)]
#[webapi(
    interface = web_api_interfaces::SVGAnimatedRect,
...
#[derive(WebApiObject)]
#[webapi(
    interface = web_api_interfaces::SVGPreserveAspectRatio,
...
#[derive(WebApiObject)]
#[webapi(
    interface = web_api_interfaces::SVGAnimatedPreserveAspectRatio,
...
#[derive(WebApiObject)]
#[webapi(interface = web_api_interfaces::SVGPointList, own_to_string_tag = "SVGPointList")]
...
#[derive(WebApiObject)]
#[webapi(interface = web_api_interfaces::SVGStringList, own_to_string_tag = "SVGStringList")]
...
pub(super) fn build_svg_animated_rect_for_view_box<'s>(
    ...
    let base_val = super::rect::build_svg_view_box_rect(scope, owner, values, false);
    let anim_val = super::rect::build_svg_view_box_rect(scope, owner, values, true);
