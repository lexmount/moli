...
pub(crate) use global_scope::{
    ...
    forget_worker_message_port_wrapper, get_worker_state, queue_worker_font_task,
    ...
    start_worker_font_face_fetch, try_worker_xhr_abort_callback,
    try_worker_xhr_reschedule_timeout_after_timeout_change, try_worker_xhr_send_callback,
    worker_allows_eval_code_generation_by_csp, worker_allows_trusted_type_policy_name_by_csp,
    worker_allows_trusted_types_eval, worker_allows_wasm_code_generation_by_csp,
