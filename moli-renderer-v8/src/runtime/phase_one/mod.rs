...
"#,
            ...
            assert_eq!(
                result.get("value").and_then(serde_json::Value::as_str),
                Some(
                    r#"{"jsRemove":{"rangeCount":1,"anchor":"parser-selection-remove-parent","anchorOffset":0,"focus":"parser-selection-remove-parent","focusOffset":0,"start":"parser-selection-remove-parent","startOffset":0,"end":"parser-selection-remove-parent","endOffset":0,"text":""},"jsMove":{"rangeCount":1,"anchor":"parser-selection-move-parent","anchorOffset":0,"focus":"parser-selection-move-parent","focusOffset":0,"start":"parser-selection-move-parent","startOffset":0,"end":"parser-selection-move-parent","endOffset":0,"text":""},"parserRemove":{"rangeCount":1,"anchor":"parser-selection-remove-parent","anchorOffset":0,"focus":"parser-selection-remove-parent","focusOffset":0,"start":"parser-selection-remove-parent","startOffset":0,"end":"parser-selection-remove-parent","endOffset":0,"text":""},"parserMove":{"rangeCount":1,"anchor":"parser-selection-move-parent","anchorOffset":0,"focus":"parser-selection-move-parent","focusOffset":0,"start":"parser-selection-move-parent","startOffset":0,"end":"parser-selection-move-parent","endOffset":0,"text":""}}"#
                ),
