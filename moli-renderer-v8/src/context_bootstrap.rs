...
pub(crate) use self::events::{
    ...
    initialize_event_object, mark_event_trusted, set_error_event_error_value,
    set_event_composed_path, set_event_internal_flag, set_event_source_value, set_event_trusted,
};
