...
#[derive(Debug, Clone, PartialEq)]
pub struct EmulatedViewportSurface {
    pub inner_width: u32,
...
impl EmulatedViewportSurface {
    pub fn from_metrics(metrics: Option<&EmulatedDeviceMetrics>) -> Self {
        metrics.map_or_else(Self::default, EmulatedDeviceMetrics::viewport_surface)
    }

    pub fn to_page_viewport_surface(&self) -> crate::page::ViewportSurface {
        crate::page::ViewportSurface {
...
pub fn viewport_surface_install_script(
