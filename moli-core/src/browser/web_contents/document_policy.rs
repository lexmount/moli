use crate::{page::PermissionOverrideRegistration, runtime::PreparedDocumentPagePolicy};
use moli_fetch::FetchConfig;
use url::Url;

use super::{WebContents, network_request_policy::merge_extra_header_layers};
use crate::browser::{BrowserContextStoragePartitionHandles, ContextEmulationDefaults};
...
pub struct InheritedDocumentPolicy {
    pub selected_web_contents: Option<crate::browser::WebContentsId>,
    ...
    pub emulation: ContextEmulationDefaults,
    pub permissions: Vec<PermissionOverrideRegistration>,
    pub storage: BrowserContextStoragePartitionHandles,
}
...
impl WebContents {
    ...
    pub fn configure_navigation_engine_policy(
        &mut self,
        inherited: &InheritedDocumentPolicy,
    ) -> Result<
        (
    ...
    pub fn capture_document_policy(
        &mut self,
        inherited: InheritedDocumentPolicy,
        final_url: &Url,
        ...
        Ok(PreparedDocumentPagePolicy {
            ...
            document_activity: surface.document_activity(),
            browser_resource_runtime,
            navigator_identity,
            network_offline,
