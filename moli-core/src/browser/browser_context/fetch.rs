...
pub struct PendingDocumentFetchCommand {
    document: DocumentHandle,
    kind: DocumentFetchCommandKind,
    pending: PendingPageCommand,
}

pub struct CompletedDocumentFetchCommand {
    document: DocumentHandle,
    kind: DocumentFetchCommandKind,
    completed: Result<CompletedPageCommand, String>,
}

pub enum DocumentFetchCommandOutcome {
    Continued(PendingSubresourceContinueOutcome),
    Complete,
}

impl DocumentFetchCommandOutcome {
    pub fn into_continue_outcome(self) -> Result<PendingSubresourceContinueOutcome, String> {
        match self {
...
impl PendingDocumentFetchCommand {
    ...
    pub async fn wait(self) -> CompletedDocumentFetchCommand {
...
impl CompletedDocumentFetchCommand {
    ...
    pub fn is_interception_update(&self) -> bool {
        matches!(
            self.kind,
...
impl BrowserContext {
    ...
    ) -> Result<(bool, Option<SubresourceResourceType>), String> {
        Ok(self
            .web_contents(web_contents)?
            .fetch_subresource_interception())
    }

    pub fn start_document_fetch_command(
        &self,
        document: DocumentHandle,
    ...
    pub fn start_web_contents_fetch_interception_update(
        &mut self,
        web_contents: WebContentsHandle,
        enabled: bool,
    ...
    pub fn install_web_contents_fetch_interception_policy(
        &mut self,
        web_contents: WebContentsHandle,
        enabled: bool,
        resource_type: Option<SubresourceResourceType>,
    ...
    pub fn finish_document_fetch_command(
        &mut self,
    ...
    pub fn finish_unobserved_document_fetch_interception_update(
        completed: CompletedDocumentFetchCommand,
    ) -> Result<DocumentFetchCommandOutcome, String> {
