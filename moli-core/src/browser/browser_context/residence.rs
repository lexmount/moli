...
impl BrowserContext {
    ...
    pub fn web_contents_locale_override(
        ...
        Ok(self.web_contents(handle)?.environment_owner.locale())
    }
    ...
    pub fn web_contents_timezone_override(
        ...
        Ok(self.web_contents(handle)?.environment_owner.timezone())
    }
    ...
    pub fn web_contents_has_non_default_policy(
        ...
        Ok(contents.network_offline
            ...
            || contents.environment_owner.locale().is_some()
            || contents.environment_owner.timezone().is_some()
