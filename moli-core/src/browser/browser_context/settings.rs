...
impl BrowserContext {
    ...
    pub fn set_default_locale_override(&mut self, locale: Option<String>) -> Result<(), String> {
        self.environment_owner
            .set_locale(locale.as_deref())
            .map_err(str::to_owned)
    }

    pub fn set_default_timezone_override(
        &mut self,
        timezone: Option<String>,
    ) -> Result<(), String> {
        self.environment_owner
            .set_timezone(timezone.as_deref())
            .map_err(str::to_owned)
    }

    pub fn default_locale_override(&self) -> Option<String> {
        self.environment_owner.locale()
    }

    pub fn default_timezone_override(&self) -> Option<String> {
        self.environment_owner.timezone()
    }
    ...
    pub fn set_default_extra_headers(&mut self, headers: moli_fetch::RequestHeaders) {
