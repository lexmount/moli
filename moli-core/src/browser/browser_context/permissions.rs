...
pub struct PendingContextPermissionUpdate {
...
pub struct CompletedContextPermissionUpdate {
    context_id: BrowserContextId,
...
impl PendingContextPermissionUpdate {
    ...
    #[doc(hidden)]
    pub fn page_count_for_test(&self) -> usize {
        self.pages.len()
    }

    pub async fn wait(self) -> CompletedContextPermissionUpdate {
...
impl BrowserContext {
    ...
    pub fn finish_permission_update(
        &mut self,
