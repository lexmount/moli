...
impl BrowserNavigationLoad {
    ...
    pub fn set_redirect_state(
        ...
        let id = self.work().expect("live navigation work");
        self.context
            .browser
            .execute(move |browser| {
                let load = browser
                    ...
                    .loads
                    .get_mut(&id)
                    .expect("live navigation work");
                load.value.set_redirect_state(headers, chain);
            })
            .expect("live Browser owner");
    }
...
impl BrowserInterceptedNavigationResponse<RawResponse> {
    pub fn retry(self) -> BrowserInterceptedNavigationLoad {
        ...
        let id = work.load.work().expect("live navigation work");
        let request = work
            .load
            .context
            .browser
