...
impl NavigationEngine {
    ...
    pub fn set_extra_http_headers(&mut self, headers: &moli_fetch::RequestHeaders) {
    ...
    async fn fetch_navigation_streaming_raw_response_async(
        ...
        self.fetch_navigation_request_async(cookie_store, request, cancel_handle)
            .await
    }

    pub async fn fetch_navigation_request_with_storage_async(
        &mut self,
        storage: NavigationResourceStorageHandles,
        request: Request,
        cancel_handle: FetchCancelHandle,
    ) -> Result<NavigationStreamingRawResponse> {
        self.fetch_navigation_request_async(storage.into_cookie_store(), request, cancel_handle)
            .await
    }

    async fn fetch_navigation_request_async(
        &mut self,
        cookie_store: SharedBrowserCookieStore,
        request: Request,
        cancel_handle: FetchCancelHandle,
...
mod tests {
    ...
    async fn response_preparation_does_not_reconfigure_shared_request_policy() {
        ...
        let client = engine
            ...
            .unwrap();
        client.set_extra_http_headers(&vec![("x-current-policy".into(), "retained".into())].into());
