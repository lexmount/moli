...
const HISTORY_BACK_FORWARD_SAME_TURN_TRAVERSES_IN_ORDER_HTML: &str = include_str!(
    "../../moli-core/tests/fixtures/runtime/history_back_forward_same_turn_traverses_in_order.html"
);
