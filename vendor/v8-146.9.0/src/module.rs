...
impl Module {
  ...
  /// Set this module's export cell to V8's uninitialized binding sentinel.
  ///
  /// This is a narrow Moli extension for browser module semantics that
  /// V8's public SyntheticModule API cannot currently express. Reading this
  /// export through the module namespace follows V8's native TheHole path and
