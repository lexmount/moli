...
unsafe extern "C" {
  ...
  fn v8__Object__SetLazyDataProperty(
    ...
    data_or_null: *const Value,
    attr: PropertyAttribute,
    getter_side_effect_type: crate::SideEffectType,
    setter_side_effect_type: crate::SideEffectType,
  ) -> MaybeBool;
  fn v8__Object__Get(
    this: *const Object,
    context: *const Context,
...
impl Object {
  ...
  /// Creates a data-like property whose value is produced on first read.
  ///
  /// After the callback returns, V8 replaces the lazy property with an
  ...
  pub fn set_lazy_data_property(
    ...
    self.set_lazy_data_property_with_configuration(
      scope,
      name,
      crate::LazyDataPropertyConfiguration::new(getter),
    )
  }
  ...
  pub fn set_lazy_data_property_with_configuration(
    ...
    scope: &PinScope<'_, '_>,
    name: Local<Name>,
    configuration: crate::LazyDataPropertyConfiguration,
  ) -> Option<bool> {
    unsafe {
  ...
  /// Returns whether this object implements the ECMAScript `[[Call]]`
  /// internal method. Unlike `Value::is_function`, this includes callable
  /// proxy objects, including revoked proxies whose call will throw.
  #[inline(always)]
