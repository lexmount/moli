...
pub(in crate::conn) struct PageSurface {
    ...
    pub(in crate::conn) navigator_queries: moli_page_types::NavigatorQueryOverrides,
...
impl PageSurface {
    ...
    pub(in crate::conn) fn document_activity(&self) -> moli_page_types::DocumentActivity {
