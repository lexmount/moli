...
pub(in crate::conn::state) struct InheritedDocumentPolicy {
    pub(in crate::conn::state) selected_web_contents: Option<moli_core::browser::WebContentsId>,
    pub(in crate::conn::state) navigator_queries: moli_page_types::NavigatorQueryOverrides,
    pub(in crate::conn::state) fetch_config: FetchConfig,
    pub(in crate::conn::state) extra_headers: moli_fetch::RequestHeaders,
