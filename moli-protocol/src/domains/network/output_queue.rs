...
use moli_fetch::{NegotiatedHttpVersion, RequestHeaders};
...
impl TargetWebSocketHandshakePlanPayload {
    fn from_subresource_record(index: usize, record: &SubresourceNetworkRecord) -> Self {
        ...
        Self {
            ...
            request_headers: record.request_headers().to_byte_strings(),
            response,
        }
    }
}
...
impl TargetSubresourceRequestStartedOutput {
    ...
    pub(crate) fn request_headers(&self) -> &RequestHeaders {
...
mod tests {
    ...
    fn request_updates_keep_frozen_start_and_request_id_without_reopening_terminal() {
        ...
        let request = |method: &str, body: &str| {
            Arc::new(SubresourceRequestStarted::new(
                ...
                method.into(),
                vec![("x-method".into(), method.into())].into(),
                Some(body.into()),
                SubresourceResourceType::Fetch,
    ...
    fn staged_subresource_outputs_deliver_ordered_events_with_stable_request_id() {
        ...
        let request = SubresourceRequestStarted::new(
            ...
            request_url.clone(),
            "GET".to_owned(),
            vec![("accept".to_owned(), "image/png".to_owned())].into(),
            None,
    ...
    fn staged_request_followed_by_complete_record_delivers_response_and_body_only() {
        ...
        let request = SubresourceRequestStarted::new(
            ...
            request_url.clone(),
            "PATCH".to_owned(),
            vec![("x-test".to_owned(), "yes".to_owned())].into(),
